...
window.SUBCONTRACT_CATEGORIES = SUBCONTRACT_CATEGORIES;
...
function ScreenSettingsSubcontracts({ go }) {
  return (
    <TwoLevelMasterPage
      prefix="SUB"
...
window.ScreenSettingsSubcontracts = ScreenSettingsSubcontracts;
