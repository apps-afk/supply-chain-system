...
/*
  ...
  Sidebar nav, topbar, icons, small UI helpers used across screens.
*/

const { useState } = React;

/* ----------------------- Icons (inline SVG) ----------------------- */
/* Stroke-based 16px icons — calm + thin */
  ...
  return (
    <aside className="side">
      ...
      <div className="side-foot">
        <div className="side-avatar">นว</div>
        <div>
          <div className="side-foot-name">นวพร ศรีวัฒน์</div>
          <div className="side-foot-role">Procurement Officer</div>
        </div>
      </div>
    </aside>
  );
...
/* Tiny SVG sparkline */
function Spark({ data, w = 80, h = 24, color }) {
...
Object.assign(window, {
  Icons, Sidebar, Topbar, Chip, Stat, Delta, Spark, Av, money
});
