      ...
      {showForgot && (
        <div style={S.overlay} onClick={() => { setShowForgot(false); setFSent(false); setFEmail(''); }}>
          <div style={S.modal} onClick={e => e.stopPropagation()}>
            ...
            {!fSent ? (
              <>
                <p style={S.modalSub}>กรอกอีเมลของคุณ — หากมีบัญชีในระบบ เราจะส่งลิงก์สำหรับตั้งรหัสผ่านใหม่ไปที่อีเมลนั้น (ลิงก์ใช้ได้ 30 นาที)</p>
              ...
              <div style={{ textAlign: 'center', padding: '16px 0' }}>
                ...
                <div style={{ fontWeight: 500, marginBottom: 8, fontFamily: 'var(--font-serif)' }}>ตรวจสอบอีเมลของคุณ</div>
                <p style={S.modalSub}>
                  หากมีบัญชี <strong>{fEmail}</strong> อยู่ในระบบ เราได้ส่งลิงก์ตั้งรหัสผ่านใหม่ไปให้แล้ว<br/>
                  ลิงก์ใช้ได้ครั้งเดียวและหมดอายุใน 30 นาที<br/>
                  (ไม่พบอีเมล? ลองดูโฟลเดอร์ Spam หรือติดต่อผู้ดูแลระบบ)
                </p>
